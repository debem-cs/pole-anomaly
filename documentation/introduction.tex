...
\begin{itemize}
    ...
    \item \texttt{1D-CNN/}: The neural network implementation, including the model architecture, training loop, inference engine, and robustness testing scripts.
